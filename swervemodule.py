...
kWheelRadius = constants.kWheelRadius
kEncoderResolution = constants.kEncoderResolution
kModuleMaxAngularVelocity = constants.kModuleMaxAngularVelocity
kModuleMaxAngularAcceleration = constants.kModuleMaxAngularAcceleration
