...
class CoralSubsystem(Subsystem):
   ...
   def __init__(self):
      ...
      self.arm_motor.configure(Configs.CoralSubsystem.armConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters)
      ...
      self.elevator_motor.configure(Configs.CoralSubsystem.elevatorConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters)
      ...
      self.intake_motor.configure(Configs.CoralSubsystem.intakeConfig, SparkBase.ResetMode.kResetSafeParameters, SparkBase.PersistMode.kPersistParameters)
   ...
   def move_to_setpoint(self):
      ...
      self.arm_controller.setReference(self.arm_current_target,  SparkLowLevel.ControlType.kMAXMotionPositionControl)
      self.elevator_controller.setReference(self.elevator_current_target, SparkLowLevel.ControlType.kMAXMotionPositionControl)
